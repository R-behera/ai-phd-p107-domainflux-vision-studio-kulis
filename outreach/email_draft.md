...
**Subject:** Prospective PhD applicant interested in robust visual and multimodal perception (statistics)

Dear Professor Kulis,

I am preparing for Fall 2027 PhD applications and have been studying your work around **Machine learning, statistics, computer vision, metric learning**. I was especially interested in the direction represented by **Information-Theoretic Metric Learning; 2007; ICML**.

I put together a small research scaffold for a project I would like to develop further: **DomainFlux Vision Studio: statistics for Kulis-Aligned Research**. The goal is to build **a robustness and failure-analysis benchmark for vision or vision-language models** focused on **statistics**, with reproducible baselines, ablations, and failure analysis rather than a demo-only implementation.
...
Private repo URL for your own reference: https://github.com/R-behera/ai-phd-p107-domainflux-vision-studio-kulis
