...
METHOD_SPEC = {
    "algorithm_id": "P107-Kulis-Statistics",
    "algorithm_name": "KulisCausalStatisticsRankAgent",
    ...
    "decision_rule": "Rank seed cases by vision-specific priority score with Kulis-aligned focus term 'statistics'.",
    "review_threshold": 0.53,
    "shift_weights": {
        "viewpoint": 0.07,
        "context": 0.1,
        "annotation": 0.12,
